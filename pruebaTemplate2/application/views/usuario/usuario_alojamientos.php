<div id="content-wrapper">
    ...
    <div class="w3-third w3-margin-bottom">
      <img src='<?php echo $product->foto ?>' alt="Norway" style="width:100%" id="foto">

      <div class="w3-container alojamiento-descripcion">    <!--w3-white-->
        <!--h3><//?php echo $product->tipo ?></h3-->
        <p><?php echo $product->tipo ?></p>
        <!--h6 class="w3-opacity">$ <//?php echo $product->precio ?></h6-->
        <p class="w3-opacity">$ <?php echo $product->precio ?></p>
...
<!--<i class="fa fa-television"></i-->
    ...
    foreach ($product->servicios as $servicio) {
        ...
        <button class="w3-button w3-block w3-black w3-margin-bottom">Modificar</button>
        <form action="<?=base_url("alojamiento/baja");?>" method="post">
          <button name="baja" class="w3-button w3-block w3-black w3-margin-bottom" value="<?php echo $product->id?>">Baja</button>
        </form>
      </div>
    </div>
