...
<div class="w3-bar w3-dark-grey">
    ...
    <div class="w3-dropdown-hover">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-white w3-card-4">
        <button class="w3-bar-item w3-button w3-text-black" name="1" value="500"> Hasta $500</button>
        <button class="w3-bar-item w3-button w3-text-black" name="2" value="500-2500"> $500 - $2500</button>
        <button class="w3-bar-item w3-button w3-text-black" name="3" value="2500-5000"> $2500 - $5000</button>
        <button class="w3-bar-item w3-button w3-text-black" name="4" value="5000-7500"> $5000 - $7500</button>
        <button class="w3-bar-item w3-button w3-text-black" name="5" value="7500-10000"> $7500 - $10000</button>
      </div>
    </div>
